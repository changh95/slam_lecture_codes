...
docker run -it --rm \
    ...
    slam_zero_to_hero:part2_ch02_05 ./feature_tracking_demo /data/sequences/00/image_0 100
```
...
docker run -it --rm \
    ...
    -e DISPLAY=$DISPLAY \
    -v /tmp/.X11-unix:/tmp/.X11-unix \
    slam_zero_to_hero:part2_ch02_05 ./run_vo_kitti /data/sequences/00/image_0 /data/poses/00.txt
```
