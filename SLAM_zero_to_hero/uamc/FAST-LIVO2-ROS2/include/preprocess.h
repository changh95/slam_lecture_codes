...
public:
  ...
  void process(const livox_custom_msg::CustomMsg::SharedPtr &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const livox_custom_msg::CustomMsg::SharedPtr &msg);
